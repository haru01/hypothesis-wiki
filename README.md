...
| インタビュー録・デモ記録を取り込み、学び(LEARN)を作成・確信度更新 | `/ingest` |
...
- **`/chabudai` → `/decide`（巻き戻し）** — 揺さぶり監査（`SELF-LEARN-005`）で「検証済み」の根拠が架空データ依存だったと露呈し、
...
├── .claude/skills/         # AgentSkills 9つ（new-project/desk-research/formulate/plan/prototype/ingest/decide/chabudai/lint・共有）
...
├── templates/              # 雛形（hypothesis/activity/learning/decision/problem-interview-script/solution-interview-script/demo-script/prototype-lp.html/prototype-mockup.html/project・共有）
