...
**読みやすく書く**（会話・レコード共通。出典: やさしい日本語ガイドライン／テクニカルライティング）:

1. 結論を先に書く。
2. 一文一義・短く（目安45字、読点は3つまで）。長い文は分ける。
3. 専門用語・カタカナ語は、初めて出すとき一言説明を添える。相手が「わからない」と言ったら言い換える。
4. 箇条書きで整理する。
5. むずかしい言い回しを避け、やさしい言葉で書く。
