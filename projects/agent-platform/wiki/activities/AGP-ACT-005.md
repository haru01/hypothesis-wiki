...
date: 2026-07-20
stage: CPF
hypotheses: [AGP-H-001, AGP-H-003, AGP-H-005, AGP-H-008]
...
対象仮説: [[AGP-H-001]] [[AGP-H-003]] [[AGP-H-005]] ／ 新規起票 [[AGP-H-008]]
...
ピボットで暫定化していた確信度を、新テーマの二次情報水準へ**再ベースライン**（旧フレーム由来の 5-6 は根拠が転移しないため二次上限へ引き下げ）。

| 仮説 | 更新前 | 更新後 | ステータス | 理由 |
|---|---|---|---|---|
| [[AGP-H-001]] | 6 | 4 | 未検証 | 〈二次〉effectuation/DDP/非線形循環が現象を支持。旧フレーム由来の6を二次上限へ是正（再ベースライン） |
| [[AGP-H-003]] | 5 | 4 | 未検証 | 〈二次〉中間の空白＋ステージゲートcategory error＋イントレ痛みが支持。旧フレーム由来を二次上限へ是正 |
| [[AGP-H-005]] | 3 | 3 | 未検証 | 〈二次〉空白はあるが Strategyzer が近接脅威。据え置き（新規性は「合成」の一点・要一次/プロトタイプ検証） |
| [[AGP-H-008]] | — | 4 | 未検証 | 〈二次〉2026査読＋category error で社内探索組織の摩擦を支持（新規起票） |

### 次のアクション

- beachhead＝社内探索組織で一次インタビュー（[[AGP-H-008]] の実コストを確認）。
- **プロトタイプで「航跡→方向の合成」を実演**し、Strategyzer との差（合成の質）を反応で検証（[[AGP-H-005]] の急所）。
