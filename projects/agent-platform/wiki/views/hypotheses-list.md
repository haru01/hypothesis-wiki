...
flowchart TB
    subgraph beh["状況・行動"]
      AGP_H_001["H-001★ 意思決定ログ不在<br/>確信度6 🔄検証中"]
    ...
    subgraph team["自分たち"]
      AGP_H_005["H-005 副産物ログ化<br/>確信度3 ⚪未検証"]
    end
    AGP_H_001 --> AGP_H_003
    AGP_H_002 --> AGP_H_003
    AGP_H_006 --> AGP_H_003
...
|---|---|---|---|---|---|---|
| [[AGP-H-001]]★ | ホワイトカラーは意思決定活動のログを残せていない | 6 | 🔄検証中 | 8 | → [[AGP-H-003]] ・ [[AGP-ACT-001]] [[AGP-ACT-002]] [[AGP-ACT-004]] | 〈架空〉揺さぶり監査で据え置き（行動事実として反証者なし＝反証耐性を確認。課題性は H-… |
...
| ID | タイトル | 確信度 | ステータス | 重要度 | 関連 | 直近の根拠 |
|---|---|---|---|---|---|---|
| [[AGP-H-005]] | AI共同作業の副産物として意思決定ログが自然に残るのが勝ち筋 | 3 | ⚪未検証 | 4 | [[AGP-ACT-001]] [[AGP-ACT-003]] | 〈二次〉3統合の空白は当たりのみ。Palantirが上位互換の脅威。一次で要検証 |
