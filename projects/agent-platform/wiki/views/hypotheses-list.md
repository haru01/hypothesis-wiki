...
|---|---|---|---|---|---|---|
| [[AGP-H-001]]★ | ホワイトカラーは意思決定の航跡（選択肢・却下理由・根拠）を残していない | 6 | 🔄検証中 | 8 | → [[AGP-H-003]] ・ [[AGP-ACT-001]] [[AGP-ACT-002]] [[AGP-ACT-004]] | 〈架空〉揺さぶり監査で据え置き（行動事実として反証者なし＝反証耐性を確認。課題性は H-… |
...
| ID | タイトル | 確信度 | ステータス | 重要度 | 関連 | 直近の根拠 |
|---|---|---|---|---|---|---|
| [[AGP-H-003]]★ | 意思決定の航跡が残らず「なぜ決めたか」を辿れない | 5 | 🔄検証中 | 8 | ← [[AGP-H-001]] ・ [[AGP-ACT-001]] [[AGP-ACT-002]] [[AGP-ACT-003]] [[AGP-ACT-004]] | 〈架空〉揺さぶりで確証バイアスを検出（反証3名・既存代替手段P-Bを未計上）。別解釈が未… |
...
| ID | タイトル | 確信度 | ステータス | 重要度 | 関連 | 直近の根拠 |
|---|---|---|---|---|---|---|
| [[AGP-H-005]] | AIと決めると Decision Record が副産物で残る（ADRの経営版） | 3 | ⚪未検証 | 4 | [[AGP-ACT-001]] [[AGP-ACT-003]] | 〈二次〉ADRの経営版という空白は当たりのみ。議事録AI・Palantirが近接脅威。一… |
