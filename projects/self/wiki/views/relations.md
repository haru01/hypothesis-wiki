...
flowchart LR
    subgraph H["仮説 H"]
      SELF_H_001["H-001 検証を反復<br/>🔄検証中"]
      SELF_H_002["H-002 学びが散在<br/>🔄検証中"]
      SELF_H_003["H-003 報告駆動更新<br/>🔄検証中"]
      SELF_H_004["H-004★ 記録が残らない<br/>🔄検証中"]
      SELF_H_005["H-005 確証バイアス<br/>🔄検証中"]
      SELF_H_006["H-006 偽の確証<br/>🔄検証中"]
      SELF_H_007["H-007 反証不能な仮説<br/>🔄検証中"]
      SELF_H_008["H-008 説明できず停滞<br/>🔄検証中"]
      SELF_H_009["H-009 AI支援+記録+レポート<br/>❌反証"]
      SELF_H_010["H-010 対価/乗り換え<br/>❌反証"]
    end
    subgraph ACT["活動 ACT"]
...
| 課題 | 対応する価値（ソリューション） |
|---|---|
| [[SELF-H-004]] 記録が残らず散逸・属人化し過去の学びが忘れられる | [[SELF-H-009]] |
| [[SELF-H-005]] 確証バイアスで反証を軽視し過大評価する | **空白** |
| [[SELF-H-006]] 好意的反応を購買意向と取り違え偽の確証で前進する | [[SELF-H-009]] |
| [[SELF-H-007]] 反証不能な曖昧仮説を成功基準なしで検証する | **空白** |
| [[SELF-H-008]] 検証の根拠を経営層に説明できず合意形成が停滞する | [[SELF-H-009]] |
