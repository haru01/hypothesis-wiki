...
- **規模**: ノード 20 ／ 辺 67 ／ **辺÷ノード = 3.35**（密（richly connected））
- **連結成分**: 1（最大成分 20 ノード）。単一成分＝全レコードが関係で繋がっている
- **孤立仮説**（どの関係も持たない）: なし
- **ハブ**（次数上位＝コーパスを束ねているレコード）: [[SELF-H-001]](10) [[SELF-H-004]](10) [[SELF-LEARN-002]](10) [[SELF-H-002]](9) [[SELF-H-008]](9)
