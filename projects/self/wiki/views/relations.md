...
- **孤立仮説**（どの関係も持たない）: なし
- **ハブ**（次数上位＝コーパスを束ねているレコード）: [[SELF-LEARN-001]](5) [[SELF-TEST-001]](5) [[SELF-H-001]](4) [[SELF-H-002]](3) [[SELF-H-003]](3)
- **下流依存度**（`leads-to` の推移閉包＝崩れると波及が大きい背骨）: [[SELF-H-001]](2) [[SELF-H-002]](1)
