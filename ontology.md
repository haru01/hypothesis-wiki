...
|---|---|---|---|
| `H` | 仮説 | `wiki/hypotheses/` | 状況・行動仮説・課題仮説・ソリューション仮説・買ってもらえる仮説・自分たち仮説 |
...
| **対応課題** | `addresses` | H（ソリューション仮説・買ってもらえる仮説） → H（課題仮説） | 配列(many) | addressed-by（対応する価値） | 任意 | ソリューション仮説→対応する課題仮説（バリュープロポジションのフィット） |
...
| SPF | Solution Product Fit | ソリューション仮説・買ってもらえる仮説 |
| PMF | Product Market Fit | 買ってもらえる仮説 |
